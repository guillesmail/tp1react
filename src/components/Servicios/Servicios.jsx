...
const Servicios = () => {
    return(
        <div>
         <section  id="trabajos" class="servicios">
        
        <div class="servicios-caja">

          <svg xmlns="http://www.w3.org/2000/svg" width="90" height="90" fill="currentColor" class="bi bi-bezier" viewBox="0 0 16 16">
        ...
        <div class="servicios-caja">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="90" height="90" fill="currentColor" class="bi bi-tablet" viewBox="0 0 16 16">
